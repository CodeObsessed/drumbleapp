...
namespace Drumble.Views
{
    public partial class Maps : PhoneApplicationPage
    {
        ...
        /// <summary> 
        /// Either the user has manipulated the image or the size of the ImageViewPort has changed. We only 
        /// care about the size. 
        /// </summary> 
        ...
        /// <param name="e"></param> 
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1500:VariableNamesShouldNotMatchFieldNames", MessageId = "xform")]
        ...
        {
            _bitmap = (BitmapImage)SystemMapImage.Source;
        ...
        {
            if (recompute && _bitmap != null && ImageViewPort != null)
            {
                // Calculate the minimum scale to fit the ImageViewPort 
                double minX = ImageViewPort.ActualWidth / _bitmap.PixelWidth;
                double minY = ImageViewPort.ActualHeight / _bitmap.PixelHeight;
