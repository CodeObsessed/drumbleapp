...
namespace DrumbleApp.Domain.Models.Entities
{
    public class PathOption : ViewModelBase
    {
        ...
        public void UpdateStageDisplay(double maxDurationInMinutes, DateTime end)
        {
            ...
            if (this.Stages.First().StartTime > DateTime.Now)
            {
                double scaledDurationInMinutes = scale * ((this.Stages.First().StartTime - DateTime.Now).TotalMinutes);
        ...
        public string ArrivalTime
        {
            get
            {
                ...
                if (!isWalkingOnly)
                {
                    string arrivalTime = this.Stages.Last().EndTime.ToShortTimeString();
        ...
        public PathOption(int order, Guid tripId, DateTime? startTime, DateTime? endTime, string estimatedTotalCost, int totalWalkingDistance, int initialWalkingDistance, IEnumerable<Stage> stages, IEnumerable<string> fareMessages, string jsonSerializedObject)
        {
            ...
            this.TimeDisplay = string.Format(AppResources.TripSelectionTimeDisplay, this.Stages.First().StartTime.ToShortTimeString(), this.Stages.Last().EndTime.ToShortTimeString());
        }
        ...
        public void UpdateUberOption(UberOption uberOption, double maxDurationInMinutes)
        {
            ...
            this.TimeDisplay = string.Format(AppResources.TripSelectionTimeDisplay, startTime.ToShortTimeString(), endTime.ToShortTimeString());
