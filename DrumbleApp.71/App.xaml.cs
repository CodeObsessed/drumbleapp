...
namespace DrumbleApp._71
{
    public partial class App : Application
    {
        ...
        private void InitializeLanguage()
        {
            try
            {
                // Custom language setup, determines if phone's current culture is supported by the app and changes the AppResources' culture to that culture.
                //if (supportedCultures.Contains(System.Globalization.CultureInfo.CurrentCulture.Name))
                //{
