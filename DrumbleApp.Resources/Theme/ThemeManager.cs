...
namespace Microsoft.Phone.Controls
{
    ...
    /// values.
    /// </summary>
    public enum ThemeManagerOverrideOption
    {
        /// <summary>
    ...
    public static class ThemeManager
    {
        static ThemeManager()
        {
            ...
            OverrideOptions = ThemeManagerOverrideOption.SystemTrayAndApplicationBars;
        }
        ...
        /// </summary>
        public static ThemeManagerOverrideOption OverrideOptions { get; set; }
        ...
        public static void SetCustomTheme(Uri styleUri, Theme themeToOverride)
        {
            ...
            {
                Debug.WriteLine("Error setting custom theme:" + ex.Message);
            }
        }
        ...
        private class RuntimeThemeResources
        {
            ...
            [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "chrome")]
            private void SetSystemComponentColors(PhoneApplicationPage page, Color background, Color foreground, Color chrome)
            {
                if (page != null)
                {
                    ...
                    if (OverrideOptions == ThemeManagerOverrideOption.SystemTrayAndApplicationBars)
                    {
            ...
            private void AttachRootFrameNavigationEvents(Color background, Color foreground, Color chrome)
            {
                ...
                if (frame != null)
                {
                    if (!(frame is Canvas))
                    {
                        ...
                        if (OverrideOptions == ThemeManagerOverrideOption.SystemTrayAndApplicationBars ||
                            OverrideOptions == ThemeManagerOverrideOption.SystemTrayColors)
                        {
            ...
            internal void SetCustomTheme(ResourceDictionary rd, Theme themeToOverride)
            {
                ...
                if (rd.Count > 0)
                {
                    ...
                    foreach (string item in items)
                    {
                        ...
                        try
                        {
                            var itemToRemove = _values.SingleOrDefault(x => x._prefix == keyName);
